...
function back_list()
{
	...
	if ($result === false) {
		...
		$leftjoin = ' LEFT JOIN ' . $GLOBALS['ecs']->table('back_order') . ' AS o ON bo.order_id = o.order_id ';
