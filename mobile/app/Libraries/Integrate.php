...
class Integrate
{
	...
	{
		// print_r($this->check_user($username, $password));exit;
	...
	public function add_user($username, $password, $email, $gender = -1, $bday = 0, $reg_date = 0, $md5password = '')
	{
		...
		$fields = array($this->field_name, $this->field_email, $this->field_pass, 'mobile_phone');
		$values = array($post_username, $email, $post_password, $post_username);
